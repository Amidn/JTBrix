...
def run_test(config_path: str, static_folder: str, timeout: int = 600, port = 5000) -> Tuple[dict, list]:
    """
    ...
    results = run_entire_test_config(config, static_folder=static_folder, timeout=timeout, port = 5000)
